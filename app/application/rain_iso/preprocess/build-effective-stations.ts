...
export function buildEffectiveStations(
  ...
  const effectiveStations: ClassifiedStation[] = [];
  const stationById = new Map(
    candidateStations.map((station) => [station.stationId, station])
  );
